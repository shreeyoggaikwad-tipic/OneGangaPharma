...
export default function CustomerLogin() {
    ...
    const [match, params] = useRoute("/:slug/customer/login");
  const selectedSlug = params?.slug; // "chaitanya", "store2", etc.

//  console.log("Detected store slug:", slug);
  ...
  const loginMutation = useMutation({
    mutationFn: (data: LoginForm ) => apiRequest("POST", "/api/auth/customer/login",{ ...data,
      slug:selectedSlug}),
    onSuccess: () => {
      toast({
  ...
  const registerMutation = useMutation({
    mutationFn: (data: RegisterForm) => apiRequest("POST", "/api/auth/customer/register", {...data,slug:selectedSlug}),
    onSuccess: () => {
      toast({
